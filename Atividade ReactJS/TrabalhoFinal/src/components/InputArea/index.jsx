...
import "./index.css";
  ...
  */
  const handleAddEvent = () => {
    ...
    if (!dateField) errors.push("Por favor, insira uma data.");
    if (!categoryField) errors.push("Por favor, selecione uma categoria.");
    if (!titleField) errors.push("Por favor, insira um título.");
    if (!valueField || isNaN(valueField)) errors.push("Por favor, insira um valor válido.");
